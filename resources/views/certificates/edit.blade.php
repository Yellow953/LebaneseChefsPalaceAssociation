...
<div class="container mt-5">
    <div class="card">
        <form action="{{ route('certificates.update', $certificate->id) }}" method="POST" enctype="multipart/form-data"
            ...
            @csrf
            <div class="card-head">
                <h1 class="text-center text-primary">Edit Certificate</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <!-- Status -->
        ...
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    ...
                    @if(pathinfo($certificate->document, PATHINFO_EXTENSION) === 'pdf')
                    <embed src="{{ asset($certificate->document) }}" type="application/pdf" width="100%" height="400px">
                    @else
                    <div>
                        <img src="{{ asset($certificate->document) }}" class="img-fluid">
                    </div>
                    @endif
                </div>
            </div>
