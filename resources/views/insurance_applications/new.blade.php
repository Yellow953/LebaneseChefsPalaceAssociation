...
<div class="container mt-5">
    <div class="card">
        <form action="{{ route('insurance_applications.create') }}" method="POST" enctype="multipart/form-data"
            class="form">
            @csrf
            <div class="card-head">
                <h1 class="text-center text-primary">New Insurance Application</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                ...
                                <option value="{{ $maritial_status }}" {{ old('maritial_status')==$maritial_status
                                    ? 'selected' : '' }}>
                                    {{ $maritial_status }}
                                </option>
                                @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="number_of_kids" step="1" min="1" max="100"
                                placeholder="Enter Number Of Kids..." value="{{ old('number_of_kids') }}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="health_status" rows="3"
                                placeholder="Enter Any Health Problems or Allergies...">{{ old('health_status') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="work_description" rows="3"
                                placeholder="Enter Your Work Experience...">{{ old('work_description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
